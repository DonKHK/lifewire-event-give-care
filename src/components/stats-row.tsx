...
export function StatsRow({ photos, supports, demoRaised, familiesHelped }: StatsRowProps) {
  return (
    <section className="mx-auto -mt-10 max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="rounded-2xl bg-white dark:bg-[#0d1a17] px-6 py-8 shadow-xl shadow-[#2A9D8F]/20 sm:px-8 sm:py-10">
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-6">
          <div className="flex flex-col items-center gap-2 p-3 text-center">
            ...
            <span className="text-sm font-medium text-slate-500 dark:text-gray-400">上載相片</span>
          </div>
          <div className="flex flex-col items-center gap-2 p-3 text-center">
            ...
            <span className="text-sm font-medium text-slate-500 dark:text-gray-400">守護支持</span>
          </div>
          <div className="flex flex-col items-center gap-2 p-3 text-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#E8F5F3]">
            ...
            <span className="text-sm font-medium text-slate-500 dark:text-gray-400">籌款總額 (HKD)</span>
          </div>
          <div className="flex flex-col items-center gap-2 p-3 text-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#FDF0ED]">
            ...
            <span className="text-sm font-medium text-slate-500 dark:text-gray-400">守護咗嘅家庭</span>
          </div>
        </div>

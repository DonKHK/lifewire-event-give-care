  ...
  return (
    <div className="animate-fade-in min-h-screen">
      ...
      <div className="mx-auto max-w-5xl px-4 pt-6 sm:px-6 lg:px-8">
        <button
          onClick={() => router.back()}
          className="group inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 transition-colors hover:text-[#2A9D8F]"
        >
      ...
      <section className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-2xl bg-white shadow-xl shadow-[#2A9D8F]/20">
          {/* Large Photo */}
          ...
          <div className="space-y-6 p-6 sm:p-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant="secondary"
                className="bg-[#E8F5F3] text-[#2A9D8F] hover:bg-[#E8F5F3]"
              >
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              >
                ...
                />
                {liked ? "已守護 💚 多謝你" : "守護呢一刻 · 支持 rare disease 家庭"}
              </Button>
              <Button
                size="xl"
                variant="outline"
                className="border-slate-300 text-slate-600 transition-all hover:bg-slate-50"
